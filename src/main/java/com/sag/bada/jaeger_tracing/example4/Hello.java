package com.sag.bada.jaeger_tracing.example4;
...
public class Hello {
	...
	private void sayHello(String helloTo, String greeting) {
		try (Scope scope = tracer.buildSpan("say-hello").startActive(true)) {
			...
			/**
			 * Add a new String greeting parameter to the sayHello method and add this
			 * instruction to it, after starting the span
			 * 
			 * By doing this we read a second command line argument as a "greeting" and
			 * store it in the baggage under "greeting" key.
			 */
	...
	public static void main(String[] args) {
		...
		/**
		 * Let's add a new parameter to our Hello's main method, so that it accepts a
		 * greeting in addition to a name.
		 */
